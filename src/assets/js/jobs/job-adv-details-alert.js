...
jQuery(document).ready(function () {
    ...
    $(document).on('click', '#chooseApp', function (e) {
        e.preventDefault();
        swal({
            title: "Are you sure to proceed with the selected applicants?",
            ...
            //e.value&&swal("Submitted!","Applicant list has been submitted.","success")
        }
        )
    });
    ...
    // CLICK SUCCESS IVIEW
    $(document).on('click', '#chooseIview', function (e) {
        e.preventDefault();
        swal({
            title: "Are you sure to proceed with the selected applicants?",
            text: "You won't be able to revert this!",
